...
<!-- Mirrored from themes.iamabdus.com/bigbag/1.1/checkout-step-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Jan 2017 09:29:49 GMT -->
...
<head>
    ...
    <title>postform | to step 1</title>
          ...
          <div class="row">
            <div class="col-xs-12">
              ...
              //  echo Session::get('result');
                ?>
                <form action="/step1" class="row" method="post" role="form">
                  <div class="col-xs-12">
                  ...
                  <div class="form-group col-sm-4 col-xs-12">
                    ...
                    <input type="text" class="form-control" name="buyer" value="4bfbc331ba5f1ab37bf266c3289a7de2c5a17196">
                  </div>
                  <div class="form-group col-sm-4 col-xs-12">
