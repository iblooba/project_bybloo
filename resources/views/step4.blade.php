...
curl_setopt_array($curl, array(
  CURLOPT_PORT => "8000",
  CURLOPT_URL => "http://124.109.0.101:8000/api/v1/contract/$contract_id/call/$medthod_name",
  ...
  CURLOPT_POSTFIELDS => "data=$keydata",
  CURLOPT_HTTPHEADER => array(
    ...
    "postman-token: b5097c4c-9239-5bd4-61a6-6e5b4d0d2551"
  ),
));
